...
export async function initShaders(gl: WebGL2RenderingContext, srcPath: string) {
    ...
    return new ShaderHandler(standardShader, baseShader, overlayShader, shadowShader)
}
...
export class ShaderHandler {
    ...
    constructor(standardShader: StandardShader, baseShader: BaseShader, overlayShader: OverlayShader, shadowShader: ShadowShader) {
